...
Y1 = np.load('/Users/paulgarnier/Desktop/Files/GitHub/datacaseOW/data/parking-couple-Y1.npy')
Y2 = np.load('/Users/paulgarnier/Desktop/Files/GitHub/datacaseOW/data/parking-couple-Y2.npy')
...
for couple in paire:
    ...
    for i in range(len(Y)):
        ...
        d = max(d,0)
        delta.append(d)
    print("Arrondissement",str(indx1)," et ",str(indx2))
    print(delta)
    plt.plot(X,delta, "g--")
    plt.title("Variation de frequentation entre 4 et 2.4 dans les arrondissements "+str(indx1)+" et "+str(indx2))
    plt.xlabel('Heure de la journée')
    plt.ylabel('Delta Frequentation')
    plt.show()
    plt.gcf().clear()
